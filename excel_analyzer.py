...
class ExcelAnalyzer:
    ...
    def browse_file(self):
        ...
        if self.load_excel_file() and self.validate_sheets():
            ...
            self.load_changelog_button["state"] = tk.NORMAL # Enable load changelog button
            self.add_entries_button["state"] = tk.NORMAL # Enable edit entries button
    ...
    def save_changes(self):
        try:
            ...
            if self.mouseDB and self.processed_data and self.file_path:
                ...
                log_file = excel_painter.mice_changelog(self.processed_data, self.mouseDB, output_dir)
                if log_file:
                    ...
                    if not self.isDebugging:
                        excel_painter.write_processed_data_to_excel(self.file_path, self.mouseDB)
                    else:
                        ...
                        excel_painter.write_processed_data_to_excel(debug_filepath, self.mouseDB)                        
